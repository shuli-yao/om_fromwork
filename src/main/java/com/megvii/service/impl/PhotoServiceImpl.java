...
public class PhotoServiceImpl implements PhotoService {
    ...
    public Integer photoToLoca(Integer queryMaxSize) throws ParseException {
        ...
        while (true) {
            ...
            for (Photo photo : photos) {
                ...
                Date queryDateTime = DateUtils.TIMEFORMAT.parse(queryDate);
    ...
    public boolean isTimeStrEquest(Date q, Date g) {
        ...
        if (DateUtils.TIMEFORMAT.format(q).equals(DateUtils.TIMEFORMAT.format(g))) {
            b = true;
        }

        log.info("节点日期:" + DateUtils.TIMEFORMAT.format(q) + ",增量数据日期:" + DateUtils.TIMEFORMAT.format(g) + ",结果为:" + b);
        return b;
    ...
    public void testInsert(String id, byte[] bytes, String cradId) {
        ...
        map.put("changeTiem", DateUtils.TIMEFORMAT.format(new Date()));
