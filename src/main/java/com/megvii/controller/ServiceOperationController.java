...
public class ServiceOperationController {
    ...
    public String allPartialImportPhoto(Integer begin,Integer end){

        //---------------执行前初始化，执行脚本信息---------------
        systemConfig.setShellConfigPath("");
        systemConfig.setTimerOnOff(false);
        systemConfig.setImprotType("all");
        //全量存储文件地址
        ...
        Thread thread =new Thread(new Runnable() {
            ...
            public void run() {
                ...
                while (true){
                    ...
                    Integer it = photoService.photoPartialToLoca(beginNumber,endNumber,"2010/01/01 00:00:00",topBeginNumber);
